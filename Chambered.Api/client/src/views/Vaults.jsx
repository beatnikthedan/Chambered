                ...
                return (
                  <div key={vault.id} className="vault-card-node" onClick={() => openEditModal(vault)}>
                    ...
                    <div className="vault-card-contents">
                      ...
                      <p className="vault-desc">{vault.description || 'No description supplied.'}</p>
            ...
            <div className="modal-tabs-body-content">
              {activeTab === 'general' && (
                <div className="tab-pane">
                  <div className="form-grid-columns">
                    ...
                    <div className="form-item">
                      <label>Vault Classification Category</label>
                      <select 
                    ...
                    <div className="form-item full-row">
                      <label>Parent Storage Hub (Nesting Support)</label>
                      <select 
                        value={form.parentVaultId}
                        onChange={(e) => setForm(prev => ({ ...prev, parentVaultId: e.target.value }))}
                      >
                        <option value="">-- None (Standalone / Root Vault) --</option>
                        {eligibleParentVaults.map(v => (
                          <option key={v.id} value={v.id}>🔗 {v.name} ({v.vaultCategoryName})</option>
                        ))}
                      </select>
                      <span className="input-hint-lbl">
                        Allows nesting lockers inside larger storage hubs (e.g. Pistol Box inside the Closet Safe).
                      </span>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'security' && (
                <div className="tab-pane">
                  <div className="form-grid-columns">
                    <div className="form-item">
                      <label>Access Lock Mechanism Type</label>
                      <select 
                        value={form.securityLevel}
                        onChange={(e) => setForm(prev => ({ ...prev, securityLevel: e.target.value }))}
                      >
                        <option value="Electronic Keypad">Electronic Keypad</option>
                        <option value="Mechanical Dial">Mechanical Dial</option>
                        <option value="Biometric Scanner">Biometric Scanner</option>
                        <option value="Dual Key System">Dual Key System</option>
                        <option value="Physical Key Lock">Physical Key Lock</option>
                        <option value="RFID Transponder">RFID Transponder</option>
                        <option value="None / Cabinet">None / Open Cabinet</option>
                      </select>
                    </div>

                    <div className="form-item">
                      <label>Lock Battery Last Replaced</label>
                      <input 
                        type="date" 
                      ...
                      />
                                      ...
                                      <div className="form-item full-row">
                                          <label>Safe Combination / Pin Passcode <span style={{ color: 'green' }}>(Encrypted)</span></label>
                    ...
                    <div className="form-item">
                      <label>Passcode Remind Hint</label>
                      <input 
                        type="text" 
                    ...
                    <div className="form-item">
                      <label>Backup Bypass Keys Location</label>
                      <input 
                        type="text" 
              ...
              {activeTab === 'inventory' && (
                <div className="tab-pane">
                  <div className="vault-inventory-wrapper">
                    <h4 className="inventory-subheading">Items Checked into Hub</h4>
